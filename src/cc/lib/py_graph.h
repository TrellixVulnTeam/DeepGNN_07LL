...
extern "C"
{
    ...
    DEEPGNN_DLL extern int32_t GetNodeType(PyGraph *graph, NodeID *node_ids, size_t node_ids_size,
                                           Timestamp *time_stamps, Type *output, Type default_type);
    ...
    DEEPGNN_DLL extern int32_t RandomWalk(PyGraph *graph, int64_t seed, float p, float q, NodeID default_node_id,
                                          NodeID *in_node_ids, size_t in_node_ids_size, Timestamp *time_stamps,
